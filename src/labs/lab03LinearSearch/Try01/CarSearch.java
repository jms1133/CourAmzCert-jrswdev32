package labs.lab03LinearSearch.Try01;
...
public class CarSearch {
    ...
    public ArrayList searchAvailability(String availability) {
        ...
        /* TODO 3: if the results is empty, print a message saying
                   nothing was found */
        if (results.isEmpty()) System.out.println("Nothing was found.");
    ...
    public ArrayList search(String make, String model, String color){
        ...
        if (results.isEmpty()) System.out.println("no model match.");
    ...
    public ArrayList searchPrice(double priceLimit, boolean lowerThan){
        ...
        // TODO 14: If the results is empty. Print a message.
         if (results.isEmpty()) System.out.println("There are no cars priced " + (lowerThan ? "below" : "above ")
                 + priceLimit + "\n");
    ...
    public static void main(String [] args){
        ...
        System.out.println("\nList cars IN STOCK");
        ArrayList carsFound = carSearch.searchAvailability("DEALER TRADE");
        if(carsFound != null) {
